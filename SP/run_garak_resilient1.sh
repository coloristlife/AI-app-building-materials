...
GENERATIONS=1         # Keep at 1 for speed
PARALLEL_ATTEMPTS=5   # Parallel requests to speed up generation
...
echo "====================================================="
echo "Starting Resilient Garak Scan for: $MODEL_NAME"
echo "Results and tracking will be saved in: $OUTPUT_DIR/"
echo "====================================================="
