...
*You must output:*
# Data Retention 
- Question: Are strict data retention and secure deletion policies defined and actively enforced across all relevant data stores (Elasticsearch, AWS S3, PostgreSQL) and any external operational environments?
